...
const Logo = () => {
  return (
    <div className="flex items-center gap-2 cursor-pointer font-sans select-none group">
      ...
      {/* Icon Badge */}
      <div className={`flex items-center justify-center sm:w-9 sm:h-9 w-7 h-7 rounded-lg
                      bg-gradient-to-br from-[#3546fd] to-[#1d4bca]
                      border-[2px] border-blue-800
                      group-hover:scale-105 transition-transform duration-300
                      `}
      >
        <span style={{ textShadow: "rgb(216 210 210 / 41%) 1px 1px 6px" }} className="sm:text-[1.6rem] text-[1.1rem] drop-shadow-sm text-white font-bold">🦉</span>
      </div>
