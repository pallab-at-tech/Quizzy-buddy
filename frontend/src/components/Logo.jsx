...
const Logo = () => {
  return (
    <div className="flex items-center gap-2 cursor-pointer font-sans select-none group">
      ...
      {/* Icon Badge */}
      <div style={{ boxShadow: "inset rgb(128 128 128 / 41%) 1px 1px 6px , inset rgb(38 57 159) 1px 1px 6px"  }} className={`flex items-center justify-center sm:w-9 sm:h-9 w-7 h-7 rounded-lg
      ...
      >
        <span className="sm:text-[1.6rem] text-[1.1rem] drop-shadow-sm text-white font-bold">
          <img src="/app-logo.png" alt="" className="w-[22px] h-[22px]"/>
        </span>
      </div>
